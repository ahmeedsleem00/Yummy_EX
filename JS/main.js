...
//   let Meal = await fetch(`https://www.themealdb.com/api/json/v1/1/search.php?s=elementabiata`);
...
//     <div id="myImages" class="content w-100 position-relative">
//         <img class="w-100 card" src="${elementstrMealThumb}" alt="">
//         <div id="mealData" class="layer">
